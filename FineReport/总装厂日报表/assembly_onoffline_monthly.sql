...
/*
 * *********************************************
 * Name: assembly_onoffline_monthly(i_plcode,i_stcode,i_mtcode,i_crtime)
 ...
 *
 * Test SQL:
 * select assembly_onoffline_monthly('ZZ0101','T00','Z99KC135LET9NW0K10',format_crtime('2014-08-15 06:00:00')) from dual;
 **/
begin
  select 
